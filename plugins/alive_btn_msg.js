...
Asena.addCommand({ pattern: 'max', fromMe: tk, desc: 'Gives The Button Menu'
}, (async (message, match) => {
...
const buttons = [
  {buttonId: HANDLER + 'absysdtxt', buttonText: {displayText: '✆ System status' }, type: 1},
  {buttonId: HANDLER + 'abversion', buttonText: {displayText: '☩ Version' }, type: 1}
]
