...
//thanks to saidali & shadow
      ...
      Asena.addCommand({pattern: 'ffpack', fromMe: fs, desc: Ln,}, (async (message, match) => {
 ...
 Asena.addCommand({ pattern: 'ff02 ?(.*)', fromMe: fs, dontAddCommandList: true }, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: '👸MADE BY ALORA BOT✅'})

    }));
 
 Asena.addCommand({ pattern: 'ff01 ?(.*)', fromMe: fs, dontAddCommandList: true }, (async (message, match) => {
  ...
  Asena.addCommand({ pattern: 'ff03 ?(.*)', fromMe: fs, dontAddCommandList: true }, (async (message, match) => {
 ...
 Asena.addCommand({ pattern: 'ff04 ?(.*)', fromMe: fs, dontAddCommandList: true }, (async (message, match) => {
  ...
  Asena.addCommand({ pattern: 'ff05 ?(.*)', fromMe: fs, dontAddCommandList: true }, (async (message, match) => {
  ...
  Asena.addCommand({ pattern: 'ff06 ?(.*)', fromMe: fs, dontAddCommandList: true }, (async (message, match) => {
  ...
  Asena.addCommand({ pattern: 'ff07 ?(.*)', fromMe: fs, dontAddCommandList: true }, (async (message, match) => {
  ...
  Asena.addCommand({ pattern: 'ff08 ?(.*)', fromMe: fs, dontAddCommandList: true }, (async (message, match) => {
  ...
  Asena.addCommand({ pattern: 'ff09 ?(.*)', fromMe: fs, dontAddCommandList: true }, (async (message, match) => {
  ...
  Asena.addCommand({ pattern: 'ff10 ?(.*)', fromMe: fs, dontAddCommandList: true }, (async (message, match) => {
  ...
  Asena.addCommand({ pattern: 'ff11 ?(.*)', fromMe: fs, dontAddCommandList: true }, (async (message, match) => {
  ...
  Asena.addCommand({ pattern: 'ff12 ?(.*)', fromMe: fs, dontAddCommandList: true }, (async (message, match) => {
  ...
  Asena.addCommand({ pattern: 'ff13 ?(.*)', fromMe: fs, dontAddCommandList: true }, (async (message, match) => {
  ...
  Asena.addCommand({ pattern: 'ff14 ?(.*)', fromMe: fs, dontAddCommandList: true }, (async (message, match) => {
  ...
  Asena.addCommand({ pattern: 'ff15 ?(.*)', fromMe: fs, dontAddCommandList: true }, (async (message, match) => {
