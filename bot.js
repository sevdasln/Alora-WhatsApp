...
// ════════════════════PLUGGINS SUCCESS🔰🔰🔰
        console.log(
         ...
         if (config.LANG == 'EN') {
             await conn.sendMessage(conn.user.jid, fs.readFileSync("./media/LOGOA.png"), MessageType.image, { caption: `┌╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌┐\n│\n├◊🤗ʜᴇʟʟᴏ ${conn.user.name}\n│\n├👩‍🦰ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴀʟᴏʀᴀ ʙᴏᴛ\n│\n├◊🧭ᴡᴏʀᴋɪɴɢ ᴀꜱ ${config.WORKTYPE}\n│\n├◊👩‍💻 ᴄᴏᴅᴇᴅ ʙʏ - ʏᴀᴢᴜᴡᴀ\n│\n├◊🤴ʏᴏᴜᴛᴜʙᴇ - Yasindu Rashmith ➲\n│\n├◊🧞ᴊᴏɪɴ ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ\n│https://chat.whatsapp.com/C2jBLMsmk7v5DC0yMHYWIV\n│\n├◊☣ᴠᴇʀꜱɪᴏɴ - ᴡɪᴛʜᴏᴜᴛ ʙᴜᴛᴛᴏɴꜱ\n├◊☘ᴠᴇʀꜱɪᴏɴ ᴄᴏᴅᴇ - 1.2.0\n│🟥🟧🟨🟩🟦🟪🟫⬛\n│📛ᴍᴇɴᴜ ᴄᴏᴍᴍᴀɴᴅ- .alora\n│\n├🗯ᴡᴇ ᴀʀᴇ ɢʟᴀᴅ ᴛᴏ ᴋɴᴏᴡ ʏᴏᴜʀ \n│ᴛʜᴏᴜɢʜᴛꜱ.\n│ᴊᴏɪɴ ᴏᴜʀ ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ꜰᴏʀ \n│ᴍᴏʀᴇ\n╰╌╌╌╌╌╌╌╌╌╌╌╌╌╌╌▻\n▬▬▬▬▬▬▬▬▬▬▬▬▬\nᴛʜᴀɴᴋ ʏᴏᴜ ꜰᴏʀ ᴄʜᴏᴏꜱɪɴɢ💚\n▬▬▬▬▬▬▬▬▬▬▬▬▬`});
...
*/
                        try {
                            ...
                            if (config.LANG == 'EN') {
                                await conn.sendMessage(conn.user.jid, fs.readFileSync("./media/ERRLOGO.jpg"), MessageType.image, { captoon: '⭕📵𝘌𝘙𝘙𝘖𝘙 𝘖𝘊𝘊𝘜𝘙𝘌𝘋 [𝐌𝐬.𝐀𝐋𝐎𝐑𝐀]🙆‍♂⭕\n⚠️𝓓𝓸𝓷𝓽 𝓡𝓮𝓹𝓮𝓪𝓽 𝓢𝓪𝓶𝓮 𝓒𝓸𝓶𝓶𝓪𝓷𝓭𝓼.....\n👑Iam Working As '+config.WORKTYPE+'!!\n\n▢▹  _This is your LOG number Dont Try Command here_\n▢▹ ~Dont be strange. Developers Will Fix Soon. Please forward this error to Support group~\n▢▷Also You Can join Our Support group More Help._ ▢▷https://chat.whatsapp.com/C2jBLMsmk7v5DC0yMHYWIV\n\n*Error:* ```' + error + '```\n\n'  });
                                
                            } else if (config.LANG == 'SI') {
                                await conn.sendMessage(conn.user.jid, fs.readFileSync("./media/ERRLOGO.jpg"), MessageType.image, { caption: '⭕📵𝘌𝘙𝘙𝘖𝘙 𝘖𝘊𝘊𝘜𝘙𝘌𝘋 [𝐌𝐬.𝐀𝐋𝐎𝐑𝐀]🙆‍♂⭕\n⚠️𝓓𝓸𝓷𝓽 𝓡𝓮𝓹𝓮𝓪𝓽 𝓢𝓪𝓶𝓮 𝓒𝓸𝓶𝓶𝓪𝓷𝓭𝓼.....\n👑Iam Working As '+config.WORKTYPE+'!!\n\n▢▹  _This is your LOG number Dont Try Command here_\n▢▹ ~Dont be strange. Developers Will Fix Soon. Please forward this error to Support group~\n▢▷Also You Can join Our Support group More Help._ ▢▷https://chat.whatsapp.com/C2jBLMsmk7v5DC0yMHYWIV\n\n*Error:* ```' + error + '```\n\n' });
